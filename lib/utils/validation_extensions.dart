...
var passwordRegExp = r"^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?!.*\s).{8,18}$";
...
extension Validations on String? {
  ...
  Function isPassword({String? errorText}) => () => this == ""
      ? ''
      : !RegExp(passwordRegExp).hasMatch(this!)
          // ? errorText ??
          //     "Password should be 8 characters, at least one uppercase letter, one lowercase letter, one number"
          ? ''
          : null;
